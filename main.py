...
file_path = '/home/murattunc/Projects/WorkBench/Data_Science/Data_Analytics_White_Blance/DATA/HAT2S_T5B_056T49-D51_23.10.2019.TXT'
...
Tab_Str='   '
End_Line = '\n'
Data_Mined_File_Path = '/home/murattunc/Projects/WorkBench/Data_Science/Data_Analytics_White_Blance/DATA_MINED' \
                       '/Data_Mined.txt '
...
for i in range(index_uv):
    String_To_Write = Color_Temp_list[i] + Tab_Str + Factory_Comp_list[i] + Tab_Str + Value_list[i] + Tab_Str + u_list[i] + Tab_Str + v_list[i] + Tab_Str + Lv_list[i] + Tab_Str +Tv_Number_list[i] + Tab_Str + WBA_Result_list[i] +  End_Line
